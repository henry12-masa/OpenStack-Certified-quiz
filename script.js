...
const quizInfo = {
  openstackOca: {
    title: "OpenStack Certified Administrator",
    desc: "OpenStackのIdentity、Compute、Network、Storage、運用、トラブルシュート"
  },
  kcna: {
    title: "Cloud Native Computing Foundation KCNA",
    desc: "Kubernetes、コンテナ、クラウドネイティブ、Observability、GitOps"
  },
  kcsa: {
    title: "Cloud Native Computing Foundation KCSA",
    desc: "Kubernetesセキュリティ、RBAC、Pod Security、NetworkPolicy、Supply Chain"
  },
  finopsPractitioner: {
    title: "FinOps Certified Practitioner",
    desc: "FinOps原則、可視化、配賦、最適化、予算、ガバナンス"
  },
  finopsProfessional: {
    title: "FinOps Certified Professional",
    desc: "高度なFinOps運用、KPI、コミットメント管理、配賦、自動化、成熟度"
  },
  vcfAdministrator: {
    title: "VMware Cloud Foundation Administrator",
    desc: "VCF、vSphere、vSAN、NSX、SDDC Manager、ライフサイクル管理"
  }
};
...
if (type === "all") {
  document.title = "クラウドインフラ資格クイズ";
  pageTitle.textContent = "クラウドインフラ資格クイズ";
  pageDesc.textContent = "6カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.openstackOca;
